...
% MULTIPLY M-file for multiply.fig
...
%
%      MULTIPLY('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MULTIPLY.M with the given input arguments.
%
%      MULTIPLY('Property','Value',...) creates a new MULTIPLY or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before multiply_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to multiply_OpeningFcn via varargin.
%
...
% Last Modified by GUIDE v2.5 26-May-2013 16:03:47
...
% varargin   command line arguments to multiply (see VARARGIN)
